...
public class PongTable extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private Player mOpponent; // vi ska connecta den med en AI
    private Ball mBall;
    private Paint mNetPaint;   ////// linjen i mellan
    private Paint mTalbeBoundsPaint;  /// denna ska vi använda oss för att fix bounds
    ...
    ///// under den här metoden ritar vi allt, bollen, line, bordet spelaren racket osv
    public void initPongTable(Context ctx,AttributeSet attr){
        ...
        // ritar linjer i mellan av bordet
        mNetPaint = new Paint();
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
         // hör har vi ritat själva pongbordet
        ...
        // här ska vi rita mellan linjen i
    ...
    public PongTable(Context context, AttributeSet attrs) {  //// initerar objektet ponttable i constructor
        super(context, attrs);
